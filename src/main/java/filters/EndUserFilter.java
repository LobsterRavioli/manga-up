...
@WebFilter(filterName = "FilterLogin", urlPatterns = { "/ProfileView/dashboard_carte_di_credito.jsp", "/ProfileView/dashboard_end_user.jsp",
        ...
        ,"/AddressCreateServlet","/visualizeCartServlet","/CreditCardCreateServlet","/CreditCardDashboardServlet","/AddressDeleteServlet","/CreditCardDeleteServlet","/checkoutPreparationServlet","/cartRemoveServlet","/cartUpdateItemServlet"/*,"/visualizeCartServlet"*/,"/CartView/cart.jsp"})
