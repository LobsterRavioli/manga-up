...
@WebFilter(filterName = "FilterLogin", urlPatterns = { "/ProfileView/dashboard_carte_di_credito.jsp", "/ProfileView/dashboard_end_user.jsp",
        ...
        ,"/AddressCreateServlet","/visualizeCartServlet","/CreditCardCreateServlet","/OrderDetailServlet","/OrderListServlet","/CreditCardDashboardServlet","/AddressDeleteServlet","/CreditCardDeleteServlet","/checkoutPreparationServlet","/cartRemoveServlet","/cartUpdateItemServlet","/checkoutServlet","/CartView/cart.jsp"})
