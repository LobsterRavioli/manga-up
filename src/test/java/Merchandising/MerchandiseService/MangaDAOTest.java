...
class MangaDAOTest {
    ...
    private static Stream<Arguments> createTestFailProvider() {
        ...
        return Stream.of(
                ...
                Arguments.of("Test case creazione prodotto fallita Editore non valido", "9997546123412","Lorem ipsum dolor sit amet, consectetur sodales sed","bordatura","ITA","VOL.5",287,(java.sql.Date)Date.valueOf("2001-02-05"),"Sanctuary 3","",25.99,3,5,3,3,"rosso","",new Collection("Mecha"),ProductState.NEW,"Akira Toriyama",new Genre("Josei")),
                ...
                Arguments.of("Test case creazione prodotto fallita lingua non valida", "9997546123412","Star Comics","bordatura","Lorem ipsum dolor sit amet, consectetur sodales sed","VOL.5",287,new Date(2001,03,05),"Sanctuary 3","",25.99,3,5,3,3,"rosso","",new Collection("Mecha"),ProductState.NEW,"Akira Toriyama",new Genre("Josei")),
                //Controllo volume
