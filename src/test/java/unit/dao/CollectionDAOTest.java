...
import Merchandising.MerchandiseService.CollectionDAO;
...
public class CollectionDAOTest {
    ...
    public void setUp() throws Exception {
        ...
        g = new CollectionDAO(ds);
    }

    @Test
    void retrieve() throws Exception{
        Assert.assertNotNull(g.retrieve("Kemita"));
    }
    ...
    void retrieveAll() throws Exception{
        Assert.assertTrue(g.retrieveAlL().size()==3);
    }
}
